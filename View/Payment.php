...
<div class="container">
  <div id="Checkout" class="inline">
      ...
      <form method ='POST' action = '../Controler/TotalPrice.php'>
          <div class="form-group">
              <label for="PaymentAmount">Payment amount</label>
              <div id="amount-placeholder">
                  <span class = 'bold'>
          ...
          <div class="form-group">
              <label or="NameOnCard">First name<sup>*</sup></label>
              <input required id="NameOnCard" class="form-control" type="text" maxlength="255" name = 'firstName'></input>
          </div>

          <div class="form-group">
              <label or="NameOnCard">Last name<sup>*</sup></label>
              <input required id="NameOnCard" class="form-control" type="text" maxlength="255" name = 'firstName'></input>
          </div>

          <div class="form-group">
              <label or="Address">Address1<sup>*</sup></label>
              <input required id="Address" class="form-control" type="text" maxlength="255" name = 'address'></input>
          </div>

          <div class="form-group">
              <label or="Address">Address 2</label>
              <input id="Address" class="form-control" type="text" maxlength="255" name = 'address2'></input>
          </div>

          <div class="form-group">
              <label or="NameOnCard">Name on card<sup>*</sup></label>
              <input required id="NameOnCard" class="form-control" type="text" maxlength="255" name= 'nameOnCard'></input>
          </div>
          
          <div class="form-group">
              <label for="CreditCardNumber">Card number<sup>*</sup></label>
              <input required minlength = '16' maxlength = '16' id="CreditCardNumber" class="null card-image form-control" type="text" name = 'cardNumber'></input>
          </div>

          <div class="form-group">
          <label for="CreditCardNumber">Payment method<sup>*<sup></label>
          <div>
              <select class = 'form-control' name = 'card-type'>
              <option class = 'null card-image form-control'>MasterCard</option>
              <option class = 'null card-image form-control'>Visa</option>
              <option class = 'null card-image form-control'>PayPal</option>
            </select>
</div>
          </div>
          <div class="expiry-date-group form-group">
              <label for="ExpiryDate">Expiry date<sup>*</sup></label>
              <input id="ExpiryDate" class="form-control" type="text" placeholder="MM / YY" maxlength="7" required></input>
          </div>
          <div class="security-code-group form-group">
              <label for="SecurityCode">Security code<sup>*</sup></label>
              <div class="input-container" >
                  <input minlength="3" maxlength="3" onkeydown= "setLength(3,'SecurityCode')" id="SecurityCode" class="form-control" type="text" required></input>
          ...
          <button id="PayButton" class="btn btn-block btn-success submit-button" type="submit" name="submitAddress">
...
<script>
	$('#PayButton').click(()=> {
		var price = $('#amount-placeholder').text()
		$.ajax({
      url: "../Controler/shippingAddress.php", 
      type: "POST",
      data:{ price:price },
      success:function(){
        console.log('deleted')
